...
function About() {
  return (
    <div id="about" name="about" className="w-full h-screen bg-neutral-900">
      ...
      I'm a front end web developer and life-long learner with a background in philosophy, film, photography and art. I have traveled and lived all over the world from rural himalayan villages to dense bustling cites like London, New York and Beijing. My diverse background has strengthened my creative and innovative problem-solving abilites which has blossemed into a passion for developing clean, user-friendly, functional code and designs with a focus on UI and UX. 
      </p>
      </div>
